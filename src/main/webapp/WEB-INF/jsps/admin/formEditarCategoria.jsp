...
<body>
	...
	<div style="display:flex;justify-content:center;margin-top:3rem;">
		<springform:form modelAttribute="categoria" action="actualizarCategoria" class="row g-3" style="width:50%; text-align:start; display:flex; flex-direction: column; align-items: center;">
			<div class="col-md-6">
